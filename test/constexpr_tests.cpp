...
TEST_CASE("Can lex arithmetic expressions")
{
  ...
  STATIC_REQUIRE(result_1->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(result_2->type == parser_test::Parser::Type::asterisk);
  ...
  STATIC_REQUIRE(result_3->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(result_4->type == parser_test::Parser::Type::plus);
  ...
  STATIC_REQUIRE(result_5->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(result_6->type == parser_test::Parser::Type::whitespace);
  ...
  STATIC_REQUIRE(result_7->type == parser_test::Parser::Type::percent);
  ...
  STATIC_REQUIRE(result_8->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(result_9->type == parser_test::Parser::Type::caret);
  ...
  STATIC_REQUIRE(result_10->type == parser_test::Parser::Type::identifier);
}
...
TEST_CASE("Can lex integer literals")
{
  ...
  STATIC_REQUIRE(lexed_int->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(lexed_hex->type == parser_test::Parser::Type::number);
  ...
  STATIC_REQUIRE(lexed_bits->type == parser_test::Parser::Type::number);
}
...
TEST_CASE("Can lex floating point literals")
{
  ...
  STATIC_REQUIRE(lexed_fp->type == parser_test::Parser::Type::number);
}
